...
import com.example.boylucky.myfirst.presenter.NewPresenter;
...
public class NewBActivity extends AppCompatActivity implements View.OnClickListener,INewView {
...
//        final String uri = "http://www.apk.anzhi.com/data3/apk/201703/14/4636d7fce23c9460587d602b9dc20714_88002100.apk";
   ...
   */
    ...
    public void onSuccess(NewBean newBean) {
        NewBean.DataBean data = newBean.getData();
